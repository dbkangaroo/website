...
## [袋鼠数据库工具 v1.9.1.210531](/zh/download/v1.9.1.210531)
1. 新增数据视图设计器
2. 新增工具栏控件（兼容GTK4）
...
## [袋鼠数据库工具 v1.8.1.210430](/zh/download/v1.8.1.210430)
...
## [袋鼠数据库工具 v1.7.1.210331](/zh/download/v1.7.1.210331)
1. 实现十六进制编辑器支持 (已完成)
2. 实现工作空间页样式支持 (已完成)
3. 增加可独立查看日志支持 (已完成)
4. 增加界面快捷键定制支持 (已完成)
...
## [袋鼠数据库工具 v1.6.1.210131](/zh/download/v1.6.1.210131)
1. 实现十六进制编辑器支持 (已完成)
2. 实现工作空间页样式支持 (已完成)
3. 增加可独立查看日志支持 (已完成)
4. 增加界面快捷键定制支持 (已完成)
...
## [袋鼠数据库工具 v1.5.1.201231](/zh/download/v1.5.1.201231)
1. 实现十六进制编辑器支持 (已完成)
2. 实现工作空间页样式支持 (已完成)
3. 增加数据图表支持 (前期开发中)
4. 数据库模型化支持 (前期开发中)

## [袋鼠数据库工具 v1.0.6.201109](/zh/download/v1.0.6.201109)
1. 更新域名为 www.datatable.online

## [袋鼠数据库工具 v1.3.1.201102](/zh/download/v1.3.1.201102)
1. 实现十六进制编辑器支持 (已完成)
2. 增加数据图表支持 (前期开发中)
3. 增加数据库连接页新样式 (前期开发中)

## [袋鼠数据库工具 v1.0.5.201019](/zh/download/v1.0.5.201019)
1. 实现单元格值上下文菜单
2. 改进数据库空值显示和编辑支持
...
## [袋鼠数据库工具 v0.99.3.200921](/zh/download/v0.99.3.200921)
1. 重构了底层容器和服务模块
2. 改善了查看数据表和SQL查询性能
3. 更新了数据表格工具栏按钮图标
4. 修复: 无法打开 MariaDB 数据库

## [袋鼠数据库工具 v0.99.2.200907](/zh/download/v0.99.2.200907)
...
## [袋鼠数据库工具 v0.99.1.200824](/zh/download/v0.99.1.200824)
1. 改进表设计器通知用户保存修改
2. 改进消息对话框标题显示
...
## [袋鼠数据库工具 v0.25.1.200601](/zh/download/v0.25.1.200601)
1. 为数据库空间导航栏添加上下文菜单
2. 为对象树数据库和模式节点添加查询.
...
## [袋鼠数据库工具 v0.21.1.200504](/zh/download/v0.21.1.200504)
...
## [袋鼠数据库工具 v0.17.0.200323](/zh/download/v0.17.0.200323)
...
## [袋鼠数据库工具 v0.12.1.200120](/zh/download/v0.12.1.200120)
...
## [袋鼠数据库工具 v0.8.1.190930](/zh/download/v0.8.1.190930)
1. 改进：生成正确的编辑 SQL 语言
2. 重构: 增加源代码编辑模块
