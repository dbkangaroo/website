...
9. Fixed: invalid sql while large text type(PostgreSQL)
10. Fixed: designer's checkbox not response.
11. Fixed: connection crashed(MySQL/PostgreSQL)
12. Fixed: can't load source of view(PostgreSQL)
