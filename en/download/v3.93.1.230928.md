...
# Kangaroo v3.93.1
The Kangaroo have made huge strides in stability, so we removed the `Beta` mark from this version `v3.93.1`, and Kangaroo officially entering the stable version release cycle. Everyone is welcome to experience it.
...
- Fixed: DateTime with 8601 format parse issue
- Fixed: model view can't handle user input
