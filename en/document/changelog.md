...
19. Improve app title bar style, more fun now.
20. Add shell notification support
21. Fixed: Access denied: you need the SUPER privilege(s) for this operation
22. Fixed: close tab view after deleted the database object.
23. Fixed: update tab view after renamed the database object.
24. Fixed: can't get system name on MacOS platform
