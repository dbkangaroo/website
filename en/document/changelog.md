...
15. Fixed: non-response while clicking the triangle icon on the tree
16. Fixed: NULL/Empty string invalid
17. Fixed: can't show view's columns in the model view
18. Fixed: enlarge model view while importing objects.
